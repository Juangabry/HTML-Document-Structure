...
def sidebar() -> rx.Component:
    return rx.el.aside(
        ...
        class_name=rx.cond(
            ...
            "fixed z-40 top-0 left-0 flex flex-col w-56 h-screen px-4 py-8 bg-white border-r border-gray-200 transition-transform duration-300 transform md:sticky md:translate-x-0",
            "fixed z-40 top-0 left-0 flex flex-col w-56 h-screen px-4 py-8 bg-white border-r border-gray-200 transition-transform duration-300 transform -translate-x-full md:sticky md:translate-x-0",
        ),
    )